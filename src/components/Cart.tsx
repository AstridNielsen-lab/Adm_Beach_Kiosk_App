...
export function Cart({ items, onClose, onUpdateQuantity, onCheckout }: CartProps) {
  ...
  if (items.length === 0) {
    return (
      <div className="fixed inset-y-0 right-0 w-full md:w-96 bg-gradient-to-br from-yellow-50 via-green-50 to-yellow-50 shadow-lg p-6 transform transition-transform z-50">
  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 w-full md:w-96 bg-gradient-to-br from-yellow-50 via-green-50 to-yellow-50 shadow-lg flex flex-col h-full z-50">
        <div className="p-6">
